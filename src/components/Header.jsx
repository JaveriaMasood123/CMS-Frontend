...
//                                 <div className="flex items-baseline space-x-4">{renderLinks()}</div>
//                             </div>
//                         </div>
//                         <div className="flex items-center">
//                             {currentUser?.role === UserRole.CUSTOMER && (
...
const AppLogo = () => (
    <div className="flex items-center space-x-2">
        <svg className="w-8 h-8" style={{ color: '#123458' }} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z" fill="currentColor"/>
            <path d="M12 5C10.14 5 8.5 6.27 8.5 7.75C8.5 9.23 10.14 10.5 12 10.5C13.86 10.5 15.5 9.23 15.5 7.75C15.5 6.27 13.86 5 12 5ZM12 9C11.04 9 10.5 8.44 10.5 7.75C10.5 7.06 11.04 6.5 12 6.5C12.96 6.5 13.5 7.06 13.5 7.75C13.5 8.44 12.96 9 12 9Z" fill="currentColor"/>
            <path d="M18 13.5C18 12.12 15.31 11 12 11C8.69 11 6 12.12 6 13.5V17H18V13.5ZM8 15.5V14.5C8.62 13.84 10.16 13 12 13C13.84 13 15.38 13.84 16 14.5V15.5H8Z" fill="currentColor"/>
        </svg>
        <span className="text-2xl font-bold" style={{ color: '#123458' }}>GourmetGo</span>
    </div>
);
...
const Header = () => {
    ...
    const baseLinkClasses = "px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300";
    ...
    return (
        <>
            <header 
                className="text-white shadow-lg sticky top-0 z-50 print:hidden"
            ...
            >
                <div className="container mx-auto px-4">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center">
                            ...
                            <div className="hidden md:block ml-10">
                                <div className="flex items-baseline space-x-2">{renderLinks()}</div>
                            </div>
                        </div>
                        <div className="flex items-center space-x-4">
                            {currentUser?.role === UserRole.CUSTOMER && (
                ...
                {isMenuOpen && (
                    <div className="md:hidden">
                        ...
                        <div 
                            className="pt-4 pb-3"
                            style={{ borderTop: '1px solid #1A1A1A', backgroundColor: '#030303' }}
                        >
                            {currentUser ? (
                                <>
                                    <div className="flex items-center px-5">
                                        <div>
                                            <div className="text-base font-medium leading-none text-white">{currentUser.name}</div>
                                            <div className="text-sm font-medium leading-none" style={{ color: '#666666' }}>{currentUser.email}</div>
                                        </div>
                                    </div>
                                    <div className="mt-3 px-2 space-y-1">
                                        <button 
