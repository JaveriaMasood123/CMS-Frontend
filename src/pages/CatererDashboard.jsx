...
//         <path fillRule="evenodd" d="M4 5a2 2 0 012-2h8a2 2 0 012 2v12a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 100 2h4a1 1 0 100-2H7zm0 4a1 1 0 100 2h4a1 1 0 100-2H7z" clipRule="evenodd" />
//     </svg>
// );
// const MenuIcon = () => (
//     <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
...
//     if (currentUser.role !== 'CATERER') { // JS-friendly role check
...
const CatererDashboard = () => {
    ...
    const baseLinkClasses = "flex items-center px-4 py-2 rounded-md transition-colors";
    const inactiveLinkClasses = "hover:bg-gray-200";
    const activeLinkClasses = "text-white font-semibold shadow-md";
    ...
    return (
        <div className="flex flex-col md:flex-row gap-8">
            <aside className="md:w-64 flex-shrink-0">
                <nav className="sticky top-24 p-4 rounded-lg shadow-lg space-y-2 border" style={{ backgroundColor: '#FFFFFF', borderColor: '#123458' }}>
                    {navLinks.map(link => (
                        <ReactRouterDOM.NavLink 
                            key={link.to} 
                            to={link.to} 
            ...
            <div className="flex-grow p-8 rounded-lg shadow-lg min-h-[calc(100vh-10rem)] border" style={{ backgroundColor: '#FFFFFF', borderColor: '#123458' }}>
                <ReactRouterDOM.Routes>
                    <ReactRouterDOM.Route path="/" element={<CatererDashboardHome />} />
                    <ReactRouterDOM.Route path="menu" element={<CatererMenuManagement />} />
                    <ReactRouterDOM.Route path="orders" element={<CatererOrderManagement />} />
