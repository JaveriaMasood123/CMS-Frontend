        ...
        if (result.success && result.user) {
            if (result.user.role === UserRole.CUSTOMER) {
                ...
                setError(
                    <>
                        Admin accounts must sign in via the{' '}
                        <ReactRouterDOM.Link to="/admin/login" className="font-medium hover:underline" style={{ color: '#123458' }}>
                            admin portal
                        </ReactRouterDOM.Link>
                        .
                    </>
                ...
                setError(
                    <>
                        Partner accounts must sign in via the{' '}
                        <ReactRouterDOM.Link to="/caterer/login" className="font-medium hover:underline" style={{ color: '#123458' }}>
                            caterer portal
                        </ReactRouterDOM.Link>
                        .
                    </>
