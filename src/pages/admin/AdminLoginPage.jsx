...
//     return (
//         <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 h-full bg-cover bg-center"
//              style={{ backgroundImage: "url('https://picsum.photos/seed/auth-bg/1600/1200')" }}>
...
const AppLogo = () => (
    <div className="flex flex-col items-center space-y-2">
        <svg className="w-16 h-16 text-[#123458]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z" fill="currentColor"/>
            <path d="M12 5C10.14 5 8.5 6.27 8.5 7.75C8.5 9.23 10.14 10.5 12 10.5C13.86 10.5 15.5 9.23 15.5 7.75C15.5 6.27 13.86 5 12 5ZM12 9C11.04 9 10.5 8.44 10.5 7.75C10.5 7.06 11.04 6.5 12 6.5C12.96 6.5 13.5 7.06 13.5 7.75C13.5 8.44 12.96 9 12 9Z" fill="currentColor"/>
            <path d="M18 13.5C18 12.12 15.31 11 12 11C8.69 11 6 12.12 6 13.5V17H18V13.5ZM8 15.5V14.5C8.62 13.84 10.16 13 12 13C13.84 13 15.38 13.84 16 14.5V15.5H8Z" fill="currentColor"/>
        </svg>
        <h1 className="text-3xl font-bold text-[#B0B0B0]">GourmetGo</h1>
    </div>
);
...
const AdminLoginPage = () => {
    ...
    return (
        <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 min-h-screen bg-[#ecd9d9]">
            <div className="max-w-md w-full bg-[#030303] rounded-xl shadow-2xl overflow-hidden border border-[#123458]">
                <div className="text-center p-8 bg-[#030303] border-b border-[#123458]">
                    <AppLogo />
                    <h2 className="mt-6 text-center text-2xl font-bold text-[#B0B0B0]">Admin Portal Sign In</h2>
                </div>
                <div className="p-8">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div className="rounded-md shadow-sm space-y-4">
                            <div className="relative">
                                <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                                    <svg className="h-5 w-5 text-[#B0B0B0]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                                        <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                                    </svg>
                                </span>
                                <input
                                    ...
                                    value={email}
                                    onChange={(e) => setEmail(e.target.value)}
                                    className="appearance-none rounded-md relative block w-full px-3 py-2 pl-10 border border-[#123458] placeholder-[#B0B0B0] text-[#B0B0B0] bg-[#030303] focus:outline-none focus:ring-[#123458] focus:border-[#123458] sm:text-sm transition-colors duration-200"
                                    placeholder="Admin email address"
                                />
                            </div>
                            <div>
                                ...
                                <div className="text-right mt-2">
                                    <ReactRouterDOM.Link 
                                        ...
                                        className="text-sm font-medium text-[#123458] hover:text-[#B0B0B0] transition-colors duration-200"
                                    >
                                        Forgot your password?
                                    </ReactRouterDOM.Link>
                                </div>
                        ...
                        <div>
                            <button
                                type="submit"
                                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-[#030303] bg-[#123458] hover:bg-[#B0B0B0] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#123458] transition-colors duration-200"
                            >
                                Sign in
                            </button>
                        </div>
                    ...
                    <div className="text-sm text-center mt-4">
                        <p>
                            <ReactRouterDOM.Link 
                                to="/" 
                                className="font-medium text-[#123458] hover:text-[#B0B0B0] text-xs transition-colors duration-200"
                            >
                                &larr; Back to main site
                            </ReactRouterDOM.Link>
                        </p>
