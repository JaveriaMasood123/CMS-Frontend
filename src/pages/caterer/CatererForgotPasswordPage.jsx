...
// const CatererForgotPasswordPage = () => {
...
//                     {step === 1 && <p className="mt-2 text-sm text-gray-600">Enter your caterer email to receive reset instructions.</p>}
...
//                             <button type="submit" className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">Continue</button>
//                             <div className="text-sm text-center mt-2">
//                                 <ReactRouterDOM.Link to="/caterer/login" className="font-medium text-teal-600 hover:text-teal-500">Return to Caterer Sign in</ReactRouterDOM.Link>
//                             </div>
//                         </form>
//                     )}
//                     {step === 2 && (
...
//                             </div>
//                             {error && <p className="text-red-500 text-sm text-center">{error}</p>}
//                             <button type="submit" className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">Verify Code</button>
//                         </form>
//                     )}
//                     {step === 3 && (
...
//                             </div>
//                             {error && <p className="text-red-500 text-sm text-center">{error}</p>}
//                             <button type="submit" className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">Reset Password</button>
//                         </form>
//                     )}
//                     {step === 4 && (
//                         <div className="text-center">
//                             <p className="text-green-700">Your password has been successfully reset.</p>
//                             <p className="mt-2 text-sm text-gray-600">You will be redirected to the caterer sign-in page shortly.</p>
//                         </div>
//                     )}
//                 </div>
//             </div>
        ...
        <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 min-h-screen" style={{ backgroundColor: '#030303' }}>
            ...
            >
                ...
                >
                    ...
                    {step === 1 && <p className="mt-2 text-sm" style={{ color: '#B0B0B0' }}>Enter your caterer email to receive reset instructions.</p>}
                ...
                <div className="p-8">
                    ...
                    {step === 4 && (
                        <div className="text-center" style={{ color: '#059669' }}>
                            ...
                            <p className="mt-2 text-sm" style={{ color: '#B0B0B0' }}>You will be redirected to the caterer sign-in page shortly.</p>
                        </div>
                    )}
                </div>
            </div>
